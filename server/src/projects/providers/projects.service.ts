...
export class ProjectsService {
  ...
  public async create(repoPath: string, userId: number): Promise<GetProjectDto> {
  ...
  public async findAll(
    ...
    const order: 'ASC' | 'DESC' = projectFiltersDto.order?.toUpperCase() === 'ASC' ? 'ASC' : 'DESC';
    ...
    return await this.paginationProvider.paginationQuery(projectFiltersDto, this.projectRepo, {
      where,
